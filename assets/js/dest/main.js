            ...
            if (n) {
              i.forEach(function (i, l) {
                var s = i,
                    ...
                    d = s.dataset.name,
                    u = "";
                e.removeClass(r.card_active, s), a && (u = s.querySelector(".".concat(t.slider_has_back)).dataset.back, a = !0), 0 == l && (e.addClass(r.card_active, s), a && (n.style.backgroundImage = "url(".concat(u, ")"))), function (t, n, i, o, r, a) {
                  var l = document.createElement("li"),
                      s = "";
                  e.addClass(r.pagination_el, l), l.className += " ".concat(r.extra), 0 == o && e.addClass(r.pag_active, l), l.dataset.name = n, "" != a ? (s = document.createElement(a.wrapper), "" != a.classes && (s.className += a.classes), s.textContent = i, l.appendChild(s)) : l.textContent = i;
                  t.appendChild(l);
                }(o, d, c, l, r, t.pagination_wrap);
              });

              var l = _toConsumableArray(o.children);
              ...
              l.forEach(function (o) {
                ...
                a && (u = d.querySelector(".".concat(t.slider_has_back)).dataset.back), s.addEventListener("click", function () {
                  ...
                  }), e.addClass(r.card_active, d), e.addClass(r.pag_active, s), a && (n.style.backgroundImage = "url(".concat(u, ")"));
                });
              });
            }
          }(t);
